...
| xu2020_adversarial_tshirt | 74% digital / 57% physical ASR on YOLOv2 T-shirt; TPS deformation model for clothing; standard physical benchmark | No — already cited for comparison |
